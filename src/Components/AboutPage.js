...
class AboutPage extends React.Component {
    render(){
        return(
            <div className="about">
            <p>
                How much trash do you produce in a year?
            </p>
            <p>
                If you were to guess, what percentage of it goes to a landfill or is recycled.
            </p>
            <p>
                Does this seem like an incalculable amount? 
            </p>
            <p>
                How about how much trash you produce in a week? A day? An hour?
            </p>
            <p>
